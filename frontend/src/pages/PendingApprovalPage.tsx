  ...
  return (
    <div className="page">
      <div className="page-header">
        <h1>Анкета на проверке</h1>
        <p className="muted">
          Этот экран остается только как резервный сценарий, если для организации включат ручное подтверждение
          специалистов. Сейчас доступ обычно открывается сразу после регистрации.
        </p>
      </div>
      ...
      <div className="card">
        <div className="form">
          <div className="info-banner">
            Если администратор включит ручное подтверждение специалистов, здесь будет отображаться статус подключения.
          </div>
